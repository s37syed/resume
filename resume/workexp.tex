  ...
  \cventry
    ...
    {Jul. 2016 - Jan. 2017}
    {
      \begin{cvitems}
        ...
        \item {Notable projects included an FTP to SFTP upgrade for businesss feeds, \& performing DevOps on a \\Bloomberg Gateway server, and an internal monitoring tool PoC}
      \end{cvitems}
    }
  \cventry
